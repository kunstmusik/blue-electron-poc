...
export class MidiKeyMapping implements BlueDataObject {
  ...
  getBaseNote(): number { return this._baseNote; }
  setBaseNote(n: number): void { this._baseNote = n; }

  getRange(): number { return this._range; }
  setRange(r: number): void { this._range = r; }
