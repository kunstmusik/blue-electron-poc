...
export default function PianoRollRulerConfigDialog({
  ...
  return (
    ...
    >
      <div
        className="bg-[#1a1a2e] border border-blue-border/50 rounded-lg text-blue-text shadow-2xl max-w-sm w-full"
      ...
      >
        <div className="p-4 space-y-4">
          ...
          <fieldset className="space-y-3 rounded border border-blue-border/35 px-3 pb-3 pt-2">
            <legend className="px-1 text-xs font-bold text-blue-text">Local Ruler Settings</legend>

            <div className="space-y-2">
              <div className="text-xs font-bold text-blue-text">Primary Ruler</div>
              <div className="flex items-center gap-2">
                <label className="text-[11px] text-blue-muted w-16 shrink-0">Format:</label>
                <select
                  className="flex-1 bg-blue-surface border border-blue-border/40 rounded px-2 py-1 text-[11px] text-blue-text cursor-pointer disabled:opacity-50"
            ...
            <div className="space-y-2">
              <div className="text-xs font-bold text-blue-text">Secondary Ruler</div>
              <label className="flex items-center gap-2 text-[11px] text-blue-text cursor-pointer">
                <input
                  type="checkbox"
