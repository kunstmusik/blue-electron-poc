...
export default function InstrumentCommentsPanel({
  ...
  return (
    <div className="flex h-full flex-col bg-blue-bg p-4">
      <textarea
        className="h-full w-full resize-none rounded-lg border border-blue-border bg-[#0d1524] px-4 py-3 text-sm text-gray-100 outline-none transition-colors placeholder:text-blue-muted focus:border-blue-accent"
        spellCheck={false}
        value={comment}
