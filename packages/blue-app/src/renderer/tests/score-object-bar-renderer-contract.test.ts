...
describe('ScoreObjectBarRendererSnapshot contract', () => {
  ...
  it('discriminated union dispatches on kind', () => {
    const snaps: ScoreObjectBarRendererSnapshot[] = [
      ...
      { kind: 'letter', letter: 'L', labelLines: [], timeBehavior: 'NONE', repeatPointBeats: null, mappingStatus: 'supported' },
      { kind: 'pianoRoll', labelLines: [], timeBehavior: 'NONE', repeatPointBeats: null, scaleDegreeCount: 12, notesDurationBeats: 0, notes: [] },
      { kind: 'audioFile', labelLines: [], audioFilePath: '', waveformKey: null },
      { kind: 'frozenSoundObject', labelLines: [], frozenWaveFileName: '', waveformKey: null, originalDurationBeats: null, currentDurationBeats: 0 },
      { kind: 'audioClip', labelLines: [], audioFilePath: '', waveformKey: null, fileStartTimeBeats: 0, audioDurationBeats: 0, looping: false, fadeInBeats: 0, fadeInType: 'LINEAR', fadeOutBeats: 0, fadeOutType: 'LINEAR' },
